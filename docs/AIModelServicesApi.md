...
[**get_ai_model_service_legacy**](AIModelServicesApi.md#get_ai_model_service_legacy) | **GET** /v1/ai-model-services/{id} | Get an AI model service by ID
...
[**list_ai_model_services_legacy**](AIModelServicesApi.md#list_ai_model_services_legacy) | **GET** /v1/ai-model-services | List AI model services
...
[**list_ai_model_services_with_models_legacy**](AIModelServicesApi.md#list_ai_model_services_with_models_legacy) | **GET** /v1/ai-model-services-with-models | List AI services with models
...
[**list_ai_models_for_service_legacy**](AIModelServicesApi.md#list_ai_models_for_service_legacy) | **GET** /v1/ai-model-services/{id}/models | List AI models for a service
...
# **get_ai_model_service_legacy**
> AIModelServiceObject get_ai_model_service_legacy(id)
...
with aigentchat.ApiClient(configuration) as api_client:
    ...
    try:
        # Get an AI model service by ID
        api_response = api_instance.get_ai_model_service_legacy(id)
        print("The response of AIModelServicesApi->get_ai_model_service_legacy:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AIModelServicesApi->get_ai_model_service_legacy: %s\n" % e)
```
...
# **list_ai_model_services_legacy**
> List[AIModelServiceObject] list_ai_model_services_legacy()
...
with aigentchat.ApiClient(configuration) as api_client:
    ...
    try:
        # List AI model services
        api_response = api_instance.list_ai_model_services_legacy()
        print("The response of AIModelServicesApi->list_ai_model_services_legacy:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AIModelServicesApi->list_ai_model_services_legacy: %s\n" % e)
```
...
# **list_ai_model_services_with_models_legacy**
> List[AIModelServiceWithModels] list_ai_model_services_with_models_legacy()
...
with aigentchat.ApiClient(configuration) as api_client:
    ...
    try:
        # List AI services with models
        api_response = api_instance.list_ai_model_services_with_models_legacy()
        print("The response of AIModelServicesApi->list_ai_model_services_with_models_legacy:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AIModelServicesApi->list_ai_model_services_with_models_legacy: %s\n" % e)
```
...
# **list_ai_models_for_service_legacy**
> List[AIModel] list_ai_models_for_service_legacy(id)
...
with aigentchat.ApiClient(configuration) as api_client:
    ...
    try:
        # List AI models for a service
        api_response = api_instance.list_ai_models_for_service_legacy(id)
        print("The response of AIModelServicesApi->list_ai_models_for_service_legacy:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AIModelServicesApi->list_ai_models_for_service_legacy: %s\n" % e)
```
