...
------------- | ------------- | -------------
[**create_ai_model_service**](AIModelServicesApi.md#create_ai_model_service) | **POST** /v1/ai-model-services | Create a new AI model service
[**delete_ai_model_service**](AIModelServicesApi.md#delete_ai_model_service) | **DELETE** /v1/ai-model-services/{id} | Delete an AI model service
[**get_ai_model_service**](AIModelServicesApi.md#get_ai_model_service) | **GET** /v1/ai-model-services/{id} | Get an AI model service by ID
[**list_ai_model_services**](AIModelServicesApi.md#list_ai_model_services) | **GET** /v1/ai-model-services | List AI model services
[**list_ai_model_services_with_models**](AIModelServicesApi.md#list_ai_model_services_with_models) | **GET** /v1/ai-model-services-with-models | List AI services with models
[**list_ai_models_for_service**](AIModelServicesApi.md#list_ai_models_for_service) | **GET** /v1/ai-model-services/{id}/models | List AI models for a service
[**update_ai_model_service**](AIModelServicesApi.md#update_ai_model_service) | **PUT** /v1/ai-model-services/{id} | Update an AI model service
