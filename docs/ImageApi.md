...
------------- | ------------- | -------------
[**create_image**](ImageApi.md#create_image) | **POST** /organizations/{org_id}/image/generate | Generates an image
...
with aigentchat.ApiClient(configuration) as api_client:
    ...
    api_instance = aigentchat.ImageApi(api_client)
    ...
    try:
        ...
        print("The response of ImageApi->create_image:\n")
        pprint(api_response)
