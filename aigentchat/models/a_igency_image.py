...
class AIgencyImage(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["agent_id", "channel_id", "message_reference_id", "message_response_to_id", "mime_type", "mission_id", "org_owner_id", "parameters", "url", "user_id", "username"]
