...
class AIModel(BaseModel):
    ...
    max_input_tokens: Optional[Annotated[int, Field(strict=True, ge=0)]] = None
    max_output_tokens: Optional[Annotated[int, Field(strict=True, ge=0)]] = None
    ...
    __properties: ClassVar[List[str]] = ["accepted_file_mimetypes", "constraints", "created_at", "description", "documentation_url", "features", "id", "internal_id", "is_public", "max_input_tokens", "max_output_tokens", "model_id", "name", "owner_id", "owner_organization_id", "parameter_definitions", "parameters", "service_host_locations", "service_id", "updated_at", "updated_by"]
