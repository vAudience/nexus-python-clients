...
class AIModelWriteDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["accepted_file_mimetypes", "constraints", "description", "documentation_url", "features", "internal_id", "is_public", "max_input_tokens", "max_output_tokens", "model_id", "name", "parameter_definitions", "parameters", "service_host_locations", "service_id"]
