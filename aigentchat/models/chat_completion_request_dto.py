...
class ChatCompletionRequestDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["agent_id", "attached_temporary_files", "channel_id", "continue_instruction_on_max_tokens", "continue_on_max_tokens", "expire_messages", "message", "message_reference_id", "message_response_to_id", "mission_id", "parameters", "set_message_history_ids", "use_channel_messages_as_history", "use_tools", "var_replacements"]
