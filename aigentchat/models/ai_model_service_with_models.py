...
class AIModelServiceWithModels(BaseModel):
    """
    AIModelServiceWithModels
    """ # noqa: E501
    models: Optional[List[AIModel]] = None
    service: Optional[AIModelServiceObject] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["models", "service"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "models": [AIModel.from_dict(_item) for _item in obj["models"]] if obj.get("models") is not None else None,
            "service": AIModelServiceObject.from_dict(obj["service"]) if obj.get("service") is not None else None
        })
