...
[**get_chat_completion_status**](ChatCompletionsApi.md#get_chat_completion_status) | **GET** /v1/organizations/{org_id}/completions/status/{client_message_id} | Get the status of a chat-completion request
...
> CompletionStatus get_chat_completion_status(org_id, client_message_id)
...
with aigentchat.ApiClient(configuration) as api_client:
    ...
    api_instance = aigentchat.ChatCompletionsApi(api_client)
    org_id = 'org_id_example' # str | organization ID
    client_message_id = 'client_message_id_example' # str | client message ID sent with the completion request

    try:
        # Get the status of a chat-completion request
        api_response = api_instance.get_chat_completion_status(org_id, client_message_id)
        print("The response of ChatCompletionsApi->get_chat_completion_status:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ChatCompletionsApi->get_chat_completion_status: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **org_id** | **str**| organization ID | 
 **client_message_id** | **str**| client message ID sent with the completion request | 
