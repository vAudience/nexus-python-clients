...
class Prompt(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["created_at", "current_version", "default_agent_id", "description", "id", "internal_id", "owner_id", "owner_organization_id", "tags", "thumbnail_url", "title", "updated_at", "versions", "visibility"]
