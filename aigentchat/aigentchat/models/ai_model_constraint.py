...
class AIModelConstraint(BaseModel):
    """
    AIModelConstraint
    """ # noqa: E501
    direction: Optional[AIModelConstraintDirection] = None
    max: Optional[StrictInt] = None
    min: Optional[StrictInt] = None
    unit: Optional[AIModelMinMaxUnit] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["direction", "max", "min", "unit"]
