...
from aigentchat.models.prompt_content_type import PromptContentType
...
class PromptContent(BaseModel):
    ...
    PromptContent
    """ # noqa: E501
    constant: Optional[PromptConstant] = None
    prompt: Optional[PromptReference] = None
    text: Optional[StrictStr] = None
    type: PromptContentType
    variable: Optional[PromptVariable] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["constant", "prompt", "text", "type", "variable"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "constant": PromptConstant.from_dict(obj["constant"]) if obj.get("constant") is not None else None,
            "prompt": PromptReference.from_dict(obj["prompt"]) if obj.get("prompt") is not None else None,
            "text": obj.get("text"),
            "type": obj.get("type"),
            "variable": PromptVariable.from_dict(obj["variable"]) if obj.get("variable") is not None else None
        })
