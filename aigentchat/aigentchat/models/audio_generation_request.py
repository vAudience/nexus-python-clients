...
class AudioGenerationRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["agent_id", "attached_files", "channel_id", "dictionary", "id", "language", "message", "message_reference_id", "message_response_to_id", "mission_id", "org_id", "output_audio_file_format", "parameters", "speed", "stream_audio", "team_ids", "user_id", "username", "voice_id", "voice_name", "with_timestamps"]
