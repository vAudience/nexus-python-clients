...
class FunctionCallResults(BaseModel):
    ...
    result_files: Optional[List[ResultFile]] = None
    ...
    __properties: ClassVar[List[str]] = ["error", "final_state", "id", "name", "result_files", "result_meta_data", "result_texts", "tool_function_id", "tool_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "name": obj.get("name"),
            "result_files": [ResultFile.from_dict(_item) for _item in obj["result_files"]] if obj.get("result_files") is not None else None,
