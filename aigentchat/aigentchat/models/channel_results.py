...
class ChannelResults(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["limit", "offset", "results", "total_results"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [Channel.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
