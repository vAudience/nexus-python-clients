...
class FileSettings(BaseModel):
    ...
    FileSettings
    """ # noqa: E501
    chat: Optional[FileChatSettings] = None
    upload: Optional[FileUploadSettings] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["chat", "upload"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "chat": FileChatSettings.from_dict(obj["chat"]) if obj.get("chat") is not None else None,
            "upload": FileUploadSettings.from_dict(obj["upload"]) if obj.get("upload") is not None else None
        })
