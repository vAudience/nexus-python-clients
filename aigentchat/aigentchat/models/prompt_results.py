...
class PromptResults(BaseModel):
    ...
    results: List[Prompt]
    stats: Optional[PromptStatistics] = None
    total_results: Optional[StrictInt] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["limit", "offset", "results", "stats", "total_results"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "stats": PromptStatistics.from_dict(obj["stats"]) if obj.get("stats") is not None else None,
