...
class AuditTrailsApi:
    ...
    @validate_call
    def get_audit_trails_by_channel_id(
        self,
        ...
        _param = self._get_audit_trails_by_channel_id_serialize(
            org_id=org_id,
    ...
    @validate_call
    def get_audit_trails_by_channel_id_with_http_info(
        self,
        org_id: Annotated[StrictStr, Field(description="organization ID")],
        channel_id: Annotated[StrictStr, Field(description="channel ID")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_audit_trails_by_channel_id_without_preload_content(
        self,
        org_id: Annotated[StrictStr, Field(description="organization ID")],
        channel_id: Annotated[StrictStr, Field(description="channel ID")],
        _request_timeout: Union[
    ...
    def _get_audit_trails_by_channel_id_serialize(
        self,
        org_id,
        channel_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/organizations/{org_id}/audit-trails/channels/{channel_id}',
