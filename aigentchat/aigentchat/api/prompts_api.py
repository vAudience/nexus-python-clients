...
class PromptsApi:
    ...
    def list_prompts(
        self,
        org_id: Annotated[StrictStr, Field(description="Organization ID")],
        visibility: Annotated[Optional[StrictStr], Field(description="Filter prompts by access visibility")] = None,
        ...
        :param org_id: Organization ID (required)
        :type org_id: str
        :param visibility: Filter prompts by access visibility
        :type visibility: str
        :param offset: Offset
        :type offset: int
        :param limit: Limit
