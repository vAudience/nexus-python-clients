...
class TagsApi:
    ...
    def list_tags(
        self,
        org_id: Annotated[StrictStr, Field(description="organization ID")],
        types: Annotated[Optional[List[StrictStr]], Field(description="Filter tags by types (comma separated, defaults to 'user')")] = None,
        ...
        :param org_id: organization ID (required)
        :type org_id: str
        :param types: Filter tags by types (comma separated, defaults to 'user')
        :type types: List[str]
