...
class TestAuditTrail(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AuditTrail:
        """Test AuditTrail
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuditTrail`
        """
        model = AuditTrail()
        if include_optional:
            return AuditTrail(
                channel_id = '0',
                messages = [
                    aigentchat.models.audit_trail_message.AuditTrailMessage(
                        ai_model_id = '0', 
                        ai_service_id = '0', 
                        channel_id = '0', 
                        channel_name = '0', 
