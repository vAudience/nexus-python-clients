...
class TestAuditTrailMessage(unittest.TestCase):
    """AuditTrailMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuditTrailMessage:
        """Test AuditTrailMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuditTrailMessage`
        """
        model = AuditTrailMessage()
        if include_optional:
    ...
    def testAuditTrailMessage(self):
        """Test AuditTrailMessage"""
