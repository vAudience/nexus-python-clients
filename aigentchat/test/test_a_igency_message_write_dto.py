                ...
                content = aigentchat.models.a_igency_message_content_list.AIgencyMessageContentList(
                    data = [
                        aigentchat.models.a_igency_message_content.AIgencyMessageContent(
                            ...
                            is_cancelled = True, 
                            text = '', 
                            text_meta_data = aigentchat.models.text_meta_data.text_meta_data(), 
                            text_mime_type = '', 
                    ...
                    full_text_mime_type = '', ),
                meta_data = None,
                parameters = aigentchat.models.a_igency_message_completion_parameters.AIgencyMessageCompletionParameters(
                    agent_id = '', 
