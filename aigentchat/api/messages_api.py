...
class MessagesApi:
    ...
    def _create_message_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/organizations/{org_id}/messages',
    ...
    def delete_message(
        ...
        cascade: Annotated[Optional[StrictBool], Field(description="Delete related message")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type id: str
        :param cascade: Delete related message
        :type cascade: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def _delete_message_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v1/organizations/{org_id}/messages/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_channel_messages_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/organizations/{org_id}/messages/channel/{channel_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _search_messages_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/organizations/{org_id}/messages/search',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
