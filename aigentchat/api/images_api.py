...
class ImagesApi:
    ...
    def create_image(
        ...
        request: Annotated[ImageGenerationRequest, Field(description="Image Generation Request")],
        ...
        :type org_id: str
        :param request: Image Generation Request (required)
    ...
    def _create_image_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/organizations/{org_id}/images/generate',
