...
from filemanager.api_response import ApiResponse, T as ApiResponseT
import filemanager.models
from filemanager import rest
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/0.22.1/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(filemanager.models, klass)
