...
class CollectionFileListResponse(BaseModel):
    ...
    files: Optional[List[CollectionFileResponse]] = None
    limit: Optional[StrictInt] = None
    offset: Optional[StrictInt] = None
    total: Optional[StrictInt] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["collection", "files", "limit", "offset", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "collection": CollectionResponse.from_dict(obj["collection"]) if obj.get("collection") is not None else None,
            "files": [CollectionFileResponse.from_dict(_item) for _item in obj["files"]] if obj.get("files") is not None else None,
            "limit": obj.get("limit"),
