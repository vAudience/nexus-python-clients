...
class CollectionListResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["collections", "limit", "offset", "summary", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "collections": [CollectionResponse.from_dict(_item) for _item in obj["collections"]] if obj.get("collections") is not None else None,
            "limit": obj.get("limit"),
            "offset": obj.get("offset"),
            "summary": CollectionSummary.from_dict(obj["summary"]) if obj.get("summary") is not None else None,
            "total": obj.get("total")
        })
