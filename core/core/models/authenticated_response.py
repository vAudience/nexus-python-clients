...
class AuthenticatedResponse(BaseModel):
    ...
    token_expires_in_sec: Optional[StrictInt] = Field(default=None, alias="tokenExpiresInSec")
    user_id: Optional[StrictStr] = Field(default=None, alias="userId")
    username: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["authenticated", "email", "name", "tokenExpiresInSec", "userId", "username"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "email": obj.get("email"),
            "name": obj.get("name"),
            "tokenExpiresInSec": obj.get("tokenExpiresInSec"),
