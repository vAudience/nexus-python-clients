...
class OrganizationDetailsResultsResponse(BaseModel):
    """
    OrganizationDetailsResultsResponse
    """ # noqa: E501
    results: List[OrganizationDetailsResponse]
    total_results: StrictInt = Field(alias="totalResults")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["results", "totalResults"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [OrganizationDetailsResponse.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
