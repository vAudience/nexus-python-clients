...
class OrganizationRoleReducedResponse(BaseModel):
    """
    OrganizationRoleReducedResponse
    """ # noqa: E501
    created_at: StrictStr = Field(alias="createdAt")
    default_member_role: StrictBool = Field(alias="defaultMemberRole")
    id: StrictStr
    name: StrictStr
    organization_id: StrictStr = Field(alias="organizationId")
    updated_at: StrictStr = Field(alias="updatedAt")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["createdAt", "defaultMemberRole", "id", "name", "organizationId", "updatedAt"]
