...
class CredentialsResponse(BaseModel):
    ...
    CredentialsResponse
    """ # noqa: E501
    otp_allowed: StrictBool
    otp_enabled: StrictBool
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["otp_allowed", "otp_enabled"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "otp_allowed": obj.get("otp_allowed"),
            "otp_enabled": obj.get("otp_enabled")
        })
