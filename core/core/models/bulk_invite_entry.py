...
class BulkInviteEntry(BaseModel):
    ...
    """ # noqa: E501
    email: StrictStr
    role_id: Optional[StrictStr] = Field(default=None, description="RoleId validity is enforced by json.Unmarshal (uuid.UUID implements TextUnmarshaler); the validate tag only gates presence.", alias="roleId")
