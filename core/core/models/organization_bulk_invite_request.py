...
class OrganizationBulkInviteRequest(BaseModel):
    """
    OrganizationBulkInviteRequest
    """ # noqa: E501
    entries: Annotated[List[BulkInviteEntry], Field(min_length=1)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [BulkInviteEntry.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None
        })
