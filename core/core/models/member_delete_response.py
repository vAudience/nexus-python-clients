...
class MemberDeleteResponse(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr
    resource_ids: List[StrictStr] = Field(alias="resourceIds")
    resources_action: StrictStr = Field(alias="resourcesAction")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "resourceIds", "resourcesAction"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "resourcesAction": obj.get("resourcesAction")
        })
