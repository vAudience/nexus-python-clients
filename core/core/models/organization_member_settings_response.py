...
class OrganizationMemberSettingsResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["chatDefaultAgentId", "createdAt", "embeddingDefaultAgentId", "id", "imageDefaultAgentId", "memberId", "organizationId", "updatedAt"]
